...
//			movPage.setDataPagamento("02/09/2017");
	...
	//	Assert.assertEquals("Data da Movimentação é obrigatório", erros.get(0)); Esta forma não é a melhor pois fica amarrada a ordem.
	//	Assert.assertTrue(erros.contains("Data da Movimentação é obrigatório")); Esta forma temos que usar uma linha pra cada resultado.
